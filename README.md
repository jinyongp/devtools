...
| Profile·port·process·proxy·dashboard·backup 전체 상태 점검 | [diagnostics](docs/doctor.md#전체-devtools-상태-확인) |
...
| 여러 서버를 함께 시작하고 상태·로그를 확인하거나 재시작·종료 | [프로젝트 서버 관리](docs/processes.md#프로젝트-서버를-함께-관리하기) |
